...
-- AddForeignKey
ALTER TABLE `ambiente` ADD CONSTRAINT `fk_ambientes_projetos1` FOREIGN KEY (`projeto_id`) REFERENCES `projeto`(`projeto_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `funcionalidade_has_projeto_and_ambiente` ADD CONSTRAINT `fk_funcionalidades_has_projetos_and_ambientes_ambientes1` FOREIGN KEY (`ambiente_id`) REFERENCES `ambiente`(`ambiente_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `funcionalidade_has_projeto_and_ambiente` ADD CONSTRAINT `fk_funcionalidades_has_projetos_and_ambientes_funcionalidades1` FOREIGN KEY (`funcionalidade_id`) REFERENCES `funcionalidade`(`funcionalidade_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `funcionalidade_has_projeto_and_ambiente` ADD CONSTRAINT `fk_funcionalidades_has_projetos_and_ambientes_projetos1` FOREIGN KEY (`projeto_id`) REFERENCES `projeto`(`projeto_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `regra` ADD CONSTRAINT `fk_regras_agregados1` FOREIGN KEY (`agregado_id`) REFERENCES `agregado`(`agregado_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `regra` ADD CONSTRAINT `fk_regras_estrategias1` FOREIGN KEY (`estrategia_id`) REFERENCES `estrategia`(`estrategia_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `usuario` ADD CONSTRAINT `fk_usuarios_clientes1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente`(`cliente_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
